    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to=b'images/posts/%Y/%m/%d', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=600)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('image', models.ImageField(null=True, upload_to=b'images/statuspics/%Y/%m/%d', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=b'images/profilepics/%Y/%m/%d', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('vote', models.IntegerField(default=0, choices=[(1, b'upvote'), (0, b'novote'), (-1, b'downvote')])),
                ('post', models.ForeignKey(to='Connect_FMS.Post')),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
            options={
