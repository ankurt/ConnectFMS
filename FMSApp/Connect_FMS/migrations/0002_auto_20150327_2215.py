...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='building',
            name='zipcode',
            field=models.CharField(default=11111, max_length=300, validators=[django.core.validators.RegexValidator(b'^[0-9]{5}$', b'Only digits 0-9 are allowed', b'Invalid zipcode')]),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='status',
            name='created_at',
            field=models.DateTimeField(auto_now_add=True, default=datetime.datetime(2015, 3, 28, 2, 15, 33, 378033, tzinfo=utc)),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='status',
        ...
        migrations.AlterField(
            model_name='status',
            name='image',
            field=models.ImageField(blank=True, upload_to=b'images/statuses/'),
        ),
        migrations.AlterField(
            model_name='user',
            name='email',
        ...
        migrations.AlterField(
            model_name='user',
            name='role',
            field=models.CharField(choices=[(b'admin', b'Administrator'), (b'student', b'Student'), (b'fms', b'FMS')], default=b'student', max_length=15),
        ),
    ]
